...
//                     <NavLink to="/home" className="px-2 py-1 transition-all text-black hover:bg-orange-600 hover:text-white">
//                       Home
//                     </NavLink>
//                     <NavLink
//                       to="/menu/64fe0022297d2b39c16712c0"
...
//                       Menu
//                     </NavLink>
//                     <NavLink to="/about" className="px-2 py-1 transition-all text-black hover:bg-orange-600 hover:text-white">
//                       About
//                     </NavLink>
//                     <NavLink to="/contact" className="px-2 py-1 transition-all text-black hover:bg-orange-600 hover:text-white">
//                       Contact
//                     </NavLink>
//                   </nav>
//                 </div>
